...
func (h *MeilisearchHandler) FindAll(c *gin.Context) {
	page := c.Query("page")
	limit := c.Query("limit")
...
func (h *MeilisearchHandler) FindByQuery(c *gin.Context) {
...
func (h *MeilisearchHandler) FindByID(c *gin.Context) {
	isbn := c.Param("isbn")
...
func NewMeilisearchHandler(searchService utils.SearchService) *MeilisearchHandler {
